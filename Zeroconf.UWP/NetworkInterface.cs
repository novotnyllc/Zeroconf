...
namespace Zeroconf
{
    class NetworkInterface : INetworkInterface
    {
        ...
        {
            await NetworkRequestAsync(requestBytes,
                                      scanTime,
                                      retries,
        ...
        // send a request on a given adapter
        public async Task NetworkRequestAsync(byte[] requestBytes,
                                              TimeSpan scanTime,
                                              int retries,
                                              int retryDelayMilliseconds,
        ...
        static async Task BindToSocketAndWriteQuery(DatagramSocket socket, byte[] bytes, NetworkAdapter adapter, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private Task ListenForAnnouncementsAsync(NetworkAdapter adapter, Action<AdapterInformation, string, byte[]> callback, CancellationToken cancellationToken)
        {
